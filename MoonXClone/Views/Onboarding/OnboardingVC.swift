...
final class OnboardingVC: UIViewController {
    ...
    weak var delegate: OnboardingDatePickerDelegate?
    ...
    private func setupPages() {
        ...
        page1.onboardingMainViewTitleText = "Welcome"
        page1.onboardingMainViewDescriptionText = "Discover new features and learn how to use the app effectively."
        page1.imageName = ImageNames.fullMoon.rawValue
        
        let page2 = OnboardingPageWithInteraction()
        delegate = page2
        
        page2.onboardingMainViewTitleText = "Stay Connected"
        page2.onboardingMainViewDescriptionText = "Stay in touch with friends and family through our easy-to-use messaging feature."
...
//            Neon.onboardingCompleted()
            ...
            delegate?.saveZodiacSign()
            
            let paywallVC = UINavigationController(rootViewController: HomeVC())
